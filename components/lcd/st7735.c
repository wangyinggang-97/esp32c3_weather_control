...
void st7735_init() {
  ...
  spi_bus_config_t buscfg = {.miso_io_num = EXAMPLE_PIN_NUM_MISO,
  ...
  gpio_set_direction(EXAMPLE_PIN_NUM_LCD_DC, GPIO_MODE_OUTPUT);
  gpio_set_direction(EXAMPLE_PIN_NUM_LCD_RST, GPIO_MODE_OUTPUT);
  gpio_set_direction(BLK_GPIO_PIN, GPIO_MODE_OUTPUT);
